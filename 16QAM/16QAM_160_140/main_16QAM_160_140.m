...
load('.\PG_unfold_par\parameter3.mat')
PGpar0 = parameter0; PGpar1 = parameter1; PGpar2 = parameter2; PGpar3 = parameter3;

load('.\FW_unfold_par\parameter0.mat')
load('.\FW_unfold_par\parameter1.mat')
load('.\FW_unfold_par\parameter2.mat')
load('.\FW_unfold_par\parameter3.mat')
FWpar0 = parameter0; FWpar1 = parameter1; FWpar2 = parameter2; FWpar3 = parameter3;

load('.\ADMM_unfold_par\parameter0.mat')
load('.\ADMM_unfold_par\parameter1.mat')
load('.\ADMM_unfold_par\parameter2.mat')
load('.\ADMM_unfold_par\parameter3.mat')
ADMMpar0 = parameter0; ADMMpar1 = parameter1; ADMMpar2 = parameter2;  ADMMpar3 = parameter3;
...
for snr_pt = 1 : (length(SNR)) 
    for simulation_no = 1 : max_no_simulations
        ...
        % HoT-PG;
        tic
        s_PG = HoT_PG(x_ini, HH, Hy, Lf,cons);
        ...
        % PG DetNet;
        tic
        s_PGunfold = PG_DetNet(x_ini, HH, Hy, 20, PGpar0, PGpar1, PGpar2, PGpar3);
        ...
        % HoT-FW;
        tic
        s_FW = HoT_FW(x_ini_box, HH, Hy, H, y, Lf, cons);
        ...
        % FW DetNet;
        tic
        s_FWunfold = FW_DetNet(x_ini, HH, Hy, 20, FWpar0, FWpar1, FWpar2, FWpar3);
        ...
        % ADMM DetNet;
        tic
        s_ADMMunfold = ADMM_DetNet(x_ini, HH, Hy, 20, ADMMpar0, ADMMpar1, ADMMpar2, ADMMpar3);
