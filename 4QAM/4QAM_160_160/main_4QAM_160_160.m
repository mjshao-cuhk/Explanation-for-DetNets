clear; close all; clc;
%% Demonstration of DetNet variants
...
% settings: 4QAM,  160 by 160 MIMO (real-sized)
% last updated on Jan. 30, 2023
% If you have any questions, please contact {mjshao,junbinliu}@link.cuhk.edu.hk
%%
%rng(0);
M = 80; N = 80; % N - number transmit symbols, M - receive dimension.
QAM_size = 4;     %QAM size
...
for snr_pt = 1 : (length(SNR)) 
    for simulation_no = 1 : max_no_simulations
        ...
        % HoT-PG;
        tic
        s_PG = HoT_PG(x_ini_box, HH, Hy, Lf);
